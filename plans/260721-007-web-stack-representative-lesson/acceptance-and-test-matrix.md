...
| H-04 timebox/kill/no synthetic score: `WD-H04`, `PR-O-H01`, `SC-013`, `PH-H04` | Timer/kill logs; score schema | 90m, 3h, total 14h assertions; eliminated numeric score rejection | Stop, mark `ELIMINATED`/no-winner, retain preview/source | Candidate protocol | OPEN-LABELLED | BLOCKS | BLOCKS |
...
| H-11 candidate retention/reproducibility: `PR-O-H02` | Candidate sources/locks and `spikes/web/evidence/retention-index.json` | `web-retention-check`; source/lock/command/evidence hashes through I5-05 | Restore source from retained bundle; stop cleanup | I5-05 merge + later cleanup authority | OPEN-LABELLED | BLOCKS handoff | BLOCKS reproducibility |
